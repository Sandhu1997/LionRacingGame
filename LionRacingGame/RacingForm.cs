...
namespace LionRacingGame
{
    public partial class RacingForm : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            punters[1] = pFactory.getPunter("Bir", MaximumBet, SukhrajBet); //getting Bir object from factory class
            punters[2] = pFactory.getPunter("Karan", MaximumBet, GurmaanBet); //getting Karan object from factory class
